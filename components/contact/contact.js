        ...
        <> 
            <div className="mt-2 m-10 flex lg:flex-row-reverse flex-col gap-x-8 gap-y-5 text-[#121212]">
                ...
                <form id="myForm" name="email-form" data-name="Email Form" className="basis-1/2 flex flex-col  gap-y-5">
                    ...
                    <div className="">
                        <div className="mb-3 text-[#f2f2f2]"><label htmlFor="Full-Name">Name</label></div>
                    ...
                    <div>
                        <div className="mb-3 text-[#f2f2f2]"><label htmlFor="Email">Email</label></div>
                    ...
                    <div>
                        <div className="mb-3 text-[#f2f2f2]"><label htmlFor="Message">Message</label></div>
